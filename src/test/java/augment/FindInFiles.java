...
public class FindInFiles {
	...
	public void findNines() throws IOException {
	    IntGraph g = new IntGraph("0:1,0:2,0:3,1:2,3:4,4:5,5:6,6:7");
...
//		boolean inMine = GraphFileSearch.contains(g, "output/mckay/nine_4.txt");
	...
	public void findNines_bug() throws IOException {
	    IntGraph g = new IntGraph("[0:1, 0:2, 0:3, 0:5, 1:2, 1:4, 1:7, 2:6, 2:8, 3:4, 3:6, 4:5, 5:8, 6:7, 7:8]");
	...
	public void findATwelve() throws IOException {
	    IntGraph g = new IntGraph("0:1,0:2,0:7,1:2,1:9,2:3,3:4,3:5,4:5,4:6,5:8,6:7,6:10,7:10,8:9,8:11,9:11,10:11");
