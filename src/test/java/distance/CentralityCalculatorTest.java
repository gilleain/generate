...
public class CentralityCalculatorTest {
    ...
    public void testPartition() {
        IntGraph g = new IntGraph("0:1,1:2,2:3,2:5,3:4");
    ...
    public void testDistance() {
        IntGraph g = new IntGraph("0:1,0:2,1:3,2:3");
    ...
    private void testCent(IntGraph g, int... expected) {
